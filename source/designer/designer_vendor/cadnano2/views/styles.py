...
HONEYCOMB_PART_MAXCOLS = 128
HONEYCOMB_PART_MAXSTEPS = 2
SQUARE_PART_MAXROWS = 100
SQUARE_PART_MAXCOLS = 100
...
PATH_SCAFFOLD_STROKE_WIDTH = 5
oligoLenBelowWhichHighlight = 18
oligoLenAboveWhichHighlight = 60
...
pxi_stap_supplemental_stroke = QColor(255, 105, 180, 190)
...
# Automatic staple workflows use one deterministic display color. Keep this
# separate from DEFAULT_STAP_COLOR for compatibility with older saved files.
AUTOMATIC_STAP_COLOR = "#000000"
