...
_supplementalStappen = QPen(styles.pxi_stap_supplemental_stroke,
                            styles.PATH_STRAND_STROKE_WIDTH)
_supplementalStappen.setCapStyle(Qt.PenCapStyle.FlatCap)
_supplementalStappen.setJoinStyle(Qt.PenJoinStyle.RoundJoin)
...
class PreXoverItem(QGraphicsPathItem):
    def __init__(self, fromVirtualHelixItem, toVirtualHelixItem, index,
                 strandType, isLowIdx, isSupplemental=False):
        ...
        self._isSupplemental = isSupplemental
        ...
        if strandType == StrandType.Scaffold:
            ...
            self._pen = _supplementalStappen
        else:
            self._pen = _stappen
