...
class Mixin:
    ...
    def num_xovers(self):
        ...
        :return:
        """
        # Every FullXover instance is stored on both participating modules.
        # The upstream implementation repeatedly generated all permutations
        # and removed duplicates one at a time, making this logging-only count
        # dominate simulated annealing.  Object identity is the intended
        # uniqueness criterion and makes the count linear.
        return len({id(xover)
